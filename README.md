...
This project implements a machine learning-based content moderation system to classify comments as toxic or non-toxic using logistic regression.   
It uses text data, processes it with TF-IDF, and incorporates SMOTE for handling class imbalance.
...
df = pd.read_csv(r'E:\your_dataset_path\archive\Copy.csv', low_memory=False)  
